...
import { updateBodegaProduct } from "../actions";

interface EditBodegaProductDialogProps {
    isOpen: boolean;
    onClose: () => void;
...
export function EditBodegaProductDialog({ isOpen, onClose, product, onSuccess }: EditBodegaProductDialogProps) {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            await updateBodegaProduct(product.id, productData);

            toast({
                title: "Product Updated",
                description: `Product "${name}" has been updated successfully in bodega inventory.`,
            });
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-lg">
                <DialogHeader>
                    <DialogTitle>Edit Bodega Product</DialogTitle>
                    <DialogDescription>
                        Update the details for this bodega product.
                    </DialogDescription>
                </DialogHeader>
